              ...
              <div className="space-y-4">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div>
                    ...
                    <Input defaultValue="Acme Corp" className="bg-input border-border" />
                  </div>
                  <div>
                    <label className="text-sm font-medium text-foreground mb-2 block">Industry</label>
                    <Input defaultValue="Software & Technology" className="bg-input border-border" />
                  </div>
                </div>
                ...
                <div>
                  <label className="text-sm font-medium text-foreground mb-2 block">Offer for Email Campaign</label>
                  <Textarea 
                ...
                <div>
                  ...
                  <Input defaultValue="San Francisco, CA" className="bg-input border-border" />
                </div>
            ...
            <div className="space-y-6">
              <Card className="p-6 bg-card border-border">
                ...
                <div className="text-center">
                  ...
                  <p className="text-sm text-muted-foreground mb-4">Almost there! Complete your profile to get better leads.</p>

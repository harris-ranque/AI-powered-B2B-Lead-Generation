  ...
  handler: async (ctx, args) => {
    ...
    if (existingProfile) {
      ...
      const mergedData = {
        ...
        services: [...new Set([...(existingProfile.services || []), ...(profileData.services || [])])],
        targetMarkets: [...new Set([...(existingProfile.targetMarkets || []), ...(profileData.targetMarkets || [])])],
        keyDifferentiators: [...new Set([...(existingProfile.keyDifferentiators || []), ...(profileData.keyDifferentiators || [])])],
        contactInfo: {
